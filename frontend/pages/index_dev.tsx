...
// 顶部先引入 MUI 组件
import { IconButton, Tooltip, Box, Modal, Typography, Button, ToggleButton, ToggleButtonGroup, Stack, SvgIcon, Switch, Collapse } from '@mui/material'
import { CheckCircle as CheckIcon, Lightbulb, ArrowForwardIos as NextIcon, Explore, Book, ChevronRight, ChevronLeft } from '@mui/icons-material'
      ...
      >
        ...
        <Box
          sx={{
            ...
            transform: isProblemExpanded ? 'translateX(0)' : 'translateX(300px)',
      ...
      >
        ...
        <Box
          sx={{
            ...
            display: 'flex',
            flexDirection: 'column',
            transform: isAlgorithmExpanded ? 'translateX(0)' : 'translateX(300px)',
            transition: 'transform 0.3s ease-in-out',
          }}
        >
          {/* 算法内容 */}
